...
import { CustomMultiValue, CustomOption, type DoctorOption } from './DoctorSelect';
...
const AppointmentsFilterPanel = ({ isOpen, onClose, doctorsList, values, onApply, onReset }: Props) => {
      ...
      <div className={`fixed top-0 right-0 h-full w-80 bg-white shadow-2xl z-50 flex flex-col transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          ...
          <div className="flex items-center gap-4">
             <button onClick={handleReset} className="flex items-center gap-1 text-sm text-gray-500 cursor-pointer font-medium hover:text-gray-700 transition-colors">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5 space-y-6">
          ...
          <div>
            ...
            <Select<DoctorOption, true>
              ...
              value={doctorOptions.filter((o) => draft.doctorIds.includes(o.value))}
              onChange={(selected) =>
                setDraft((prev) => ({
                  ...prev,
                  doctorIds: selected ? selected.map((s) => s.value) : [],
                }))
              }
          ...
          <div>
            ...
            <div className="flex gap-3">
              <div className="relative flex-1">
                <svg className="pointer-events-none absolute left-2.5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
